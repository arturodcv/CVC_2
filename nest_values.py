...
collect_data_folder = 'results_collect_data_28'
...
#Delays
delay_exc = 1.0 ; delay_exc_large = 1.0 ; delay_inh = 0.5
slowness_exc = 1.0; slowness_exc_large = 1.0; slowness_inh = 0.05
...
ratio_inh_exc_w = 4.0
p_center_inh_exc = 1.0 ;        weight_inh_exc = - ratio_inh_exc_w * 0.15
